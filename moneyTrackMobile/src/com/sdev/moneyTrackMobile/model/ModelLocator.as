//Model Locator
package com.sdev.moneyTrackMobile.model {
...
//	import com.basf.core.business.ActivityMonitor;
	...
	public class ModelLocator implements com.adobe.cairngorm.model.ModelLocator {
		...
		private static var modelLocatorInstance:com.sdev.moneyTrackMobile.model.ModelLocator;
		...
		{
			if (com.sdev.moneyTrackMobile.model.ModelLocator.modelLocatorInstance != null ) {
				throw new Error ("Solamente se puede levantar una sesion del ModelLocator");
			}
		}
		
		public static function getInstance ():com.sdev.moneyTrackMobile.model.ModelLocator { 
			
			//si no esta creado lo instancia por primera vez
			if (modelLocatorInstance == null ) {
				modelLocatorInstance = new com.sdev.moneyTrackMobile.model.ModelLocator();
			}
